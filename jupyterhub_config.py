...
#
# c.LocalGoogleOAuthenticator.oauth_callback_url = 'http://localhost:8000/hub/oauth_callback'
# c.LocalGoogleOAuthenticator.oauth_client_id = ' 991322998242-psietjplvq6ncn1q67mcqj5cj98ki1u6.apps.googleusercontent.com'
# c.LocalGoogleOAuthenticator.oauth_client_secret = 'TYTYKIp1GqTXhEM04xLwXHmP'

#### end Google config

############## CUstom github config
# from oauthenticator.github import LocalGitHubOAuthenticator
# c.JupyterHub.authenticator_class = LocalGitHubOAuthenticator
#
# c.LocalGitHubOAuthenticator.oauth_callback_url = 'https://localhost:8000/hub/oauth_callback'
# c.LocalGitHubOAuthenticator.client_id = 'a9a02d5a0f519e1d6b8f'
...
#c.JupyterHub.cookie_secret_file = 'jupyterhub_cookie_secret-bak'

## The location of jupyterhub data files (e.g. /usr/local/share/jupyterhub)
#c.JupyterHub.data_files_path = '/Users/user/anaconda2/envs/py2/share/jupyterhub'
...
# c.Authenticator.admin_users = set({'rs'})
